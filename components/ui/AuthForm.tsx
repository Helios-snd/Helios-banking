  ...
  return (
    ...
    { type === 'sign-up'&&(
      ...
      <div className='flex gap-4'>
          ...
          <CustomInput
          control={form.control}
          name='address1' label='Address' placeholder='Enter your specefic address'
          /> 
          <CustomInput
          control={form.control}
   ...
   <div className='flex gap-4'>
          <CustomInput
          control={form.control}
          name='state' label='State' placeholder='ex: WB'
          />       

          <CustomInput
          control={form.control}
          name='postalCode' label='PIN Code' placeholder='ex: 743411'
          />     
   </div>
